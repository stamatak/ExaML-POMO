...
static inline void computeVectorGTRCATPROT(double *lVector, int *eVector, double ki, size_t i, double qz, double rz,
					   traversalInfo *ti, double *EIGN, double *EI, double *EV, double *tipVector, 
					   unsigned  char **yVector, int mxtips);

static double evaluatePartialGTRCATPROT(size_t i, double ki, int counter,  traversalInfo *ti, double qz,
					int w, double *EIGN, double *EI, double *EV,
					double *tipVector, unsigned char **yVector, 
					int branchReference, int mxtips);

static inline void computeVectorGTRGAMMAPROT(double *lVector, int *eVector, double *gammaRates, size_t i, double qz, double rz,
					     traversalInfo *ti, double *EIGN, double *EI, double *EV, double *tipVector, 
					     unsigned  char **yVector, int mxtips);

static double evaluatePartialGTRGAMMAPROT(size_t i, int counter,  traversalInfo *ti, double qz,
					  int w, double *EIGN, double *EI, double *EV,
					  double *tipVector, unsigned char **yVector, 
					  double *gammaRates,
					  int branchReference, int mxtips);

static inline void computeVectorGTRCAT(double *lVector, int *eVector, double ki, size_t i, double qz, double rz,
				       traversalInfo *ti, double *EIGN, double *EI, double *EV, double *tipVector, 
				       unsigned char **yVector, int mxtips);

static double evaluatePartialGTRCAT(size_t i, double ki, int counter,  traversalInfo *ti, double qz,
				    int w, double *EIGN, double *EI, double *EV,
				    double *tipVector, unsigned  char **yVector, 
				    int branchReference, int mxtips);


static inline void computeVectorGTRCAT_BINARY(double *lVector, int *eVector, double ki, size_t i, double qz, double rz,
					      traversalInfo *ti, double *EIGN, double *EI, double *EV, double *tipVector, 
					      unsigned char **yVector, int mxtips);

static double evaluatePartialGTRCAT_BINARY(size_t i, double ki, int counter,  traversalInfo *ti, double qz,
					   int w, double *EIGN, double *EI, double *EV,
					   double *tipVector, unsigned  char **yVector, 
					   int branchReference, int mxtips);
...
static inline void computeVectorCAT_FLEX(double *lVector, int *eVector, double ki, size_t i, double qz, double rz,
					 traversalInfo *ti, double *EIGN, double *EI, double *EV, double *tipVector, 
...
double evaluatePartialGeneric (tree *tr, size_t i, double ki, int _model)
{
  double result;
  int 
    branchReference,
...
static double evaluatePartialGTRCAT_BINARY(size_t i, double ki, int counter,  traversalInfo *ti, double pz,
					   int w, double *EIGN, double *EI, double *EV,
					   double *tipVector, unsigned  char **yVector, 
					   int branchReference, int mxtips)
{
  ...
  double   *x1, *x2; 
  int scale = 0, k;
  double *lVector = (double *)malloc(sizeof(double) * 2 * (size_t)mxtips);  
...
static double evaluatePartialGTRCATPROT(size_t i, double ki, int counter,  traversalInfo *ti, double pz,
					int w, double *EIGN, double *EI, double *EV,
					double *tipVector, unsigned char **yVector, 
					int branchReference, int mxtips)
{
  ...
  int scale = 0, k, l;
  double 
    *lVector = (double *)malloc_aligned(sizeof(double) * 20 * (size_t)mxtips),
...
static double evaluatePartialGTRGAMMAPROT(size_t i, int counter,  traversalInfo *ti, double pz,
					  int w, double *EIGN, double *EI, double *EV,
					  double *tipVector, unsigned char **yVector, 
					  double *gammaRates,
					  int branchReference, int mxtips)
{
  ...
  int scale = 0, k, l, j;
  double 
    *lVector = (double *)malloc_aligned(sizeof(double) * 80 * (size_t)mxtips),
    myEI[400]  __attribute__ ((aligned (BYTE_ALIGNMENT)));
...
static double evaluatePartialGTRCAT(size_t i, double ki, int counter,  traversalInfo *ti, double pz,
				    int w, double *EIGN, double *EI, double *EV,
				    double *tipVector, unsigned  char **yVector, 
				    int branchReference, int mxtips)
{
  ...
  double   *x1, *x2; 
  int scale = 0, k;
  double *lVector = (double *)malloc_aligned(sizeof(double) * 4 * (size_t)mxtips);    
