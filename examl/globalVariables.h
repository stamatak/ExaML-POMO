...
partitionLengths pLengths[MAX_MODEL] = {
  ...
  {4,   4,   2,  4,  4, 1, 2,  8, 2, 2, FALSE, 3, (char*)NULL, 2, FALSE, bitVectorIdentity},
  
  /* DNA */
  {16,  16,  4, 16, 16, 6, 4, 64, 6, 4, FALSE, 15, (char*)NULL, 4, FALSE, bitVectorIdentity},
        
  /* AA */
  {400, 400, 20, 400, 400, 190, 20, 460, 190, 20, FALSE, 22, (char*)NULL, 20, TRUE, bitVectorAA},
  ...
  /* 32 states */
  {1024, 1024, 32, 1024, 1024, 496, 32, 1056, 496, 32, FALSE, 32, (char*)NULL, 32, TRUE, bitVector32},
  
  /* 64 states */
  {4096, 4096, 64, 4096, 4096, 2016, 64, 4160, 64, 2016, FALSE, 64, (char*)NULL, 64, TRUE, (unsigned int*)NULL},

  //mth some pre-defined lengths etc. for 10-state POMO models
  
  /* POMO_16 */
  
  {256,  256,  16, 256,  256,  120,  16,   0, 120,  16, FALSE, 16, (char*)NULL,               16, FALSE, (unsigned int*)NULL},

  /* POMO_64 */
  
  {4096, 4096, 64, 4096, 4096, 2016, 64, 0, 2016, 64, FALSE, 64,   (char *)NULL,              64, FALSE, (unsigned int*)NULL}
